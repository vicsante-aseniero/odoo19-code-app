...
This is a user/assistant prompt template for writing the ANALYSIS file of the repository.

User request: "Create a comprehensive analysis of the repository, list main components, submodules, and recommendations."
Assistant response: Add an ANALYSIS document covering the repo overview, submodules, observations, recommendations, and next steps.

ANALYSIS content (copy below):
