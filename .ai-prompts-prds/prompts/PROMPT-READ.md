...
This is a user/assistant prompt template for writing or updating README content. Use the README content below to keep the repository documentation up-to-date.

User request: "Create or update the README with info about Odoo, OpenEducat and tutorials."
Assistant response: Add a clear README with Quick Start, submodule information, and run/test instructions.

README content (copy below):
